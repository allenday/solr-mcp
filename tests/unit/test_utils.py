...
def test_sanitize_filters():
    ...
    # Test list input
    assert SolrUtils.sanitize_filters(["field1:value1", "field2:value2"]) == ["field1:value1", "field2:value2"]
    ...
    # Test sanitization
    assert SolrUtils.sanitize_filters("field;value") == ["fieldvalue"]  # Removes semicolons
...
def test_sanitize_fields():
    ...
    # Test sanitization
    assert SolrUtils.sanitize_fields("field;name") == ["fieldname"]  # Removes semicolons
