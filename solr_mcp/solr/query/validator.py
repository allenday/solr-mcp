        ...
        try:
            ...
            for field in fields:
                if field not in available_fields:
                    raise QueryError(f"Invalid field '{field}' - field does not exist in collection '{collection}'")
        ...
        try:
            ...
            if direction:
                ...
                if direction.lower() not in [d.lower() for d in valid_directions]:
                    raise QueryError(f"Invalid sort direction '{direction}' for field '{field}'")
            else:
