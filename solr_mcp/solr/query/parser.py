...
from sqlglot.expressions import Select, From, Column, Identifier, Where, Binary, Ordered, Star, Table, Alias
        ...
        try:
            ...
            if isinstance(from_expr, Table):
                ...
                if isinstance(from_expr.this, Table):
                    ...
                    collection = from_expr.this.name
                elif hasattr(from_expr.this, 'this') and isinstance(from_expr.this.this, (Table, Identifier)):
        ...
        if ast.args.get('order'):
            for expr in ast.args['order']:
                if isinstance(expr, Ordered):
                    field = expr.this.name if isinstance(expr.this, Identifier) else expr.this.args['this'].name
