...
class QueryError(SolrError):
    ...
    def __init__(self, message: str, error_type: Optional[str] = None, response_time: Optional[int] = None):
...
class DocValuesError(QueryError):
    ...
    def __init__(self, message: str, response_time: Optional[int] = None):
        super().__init__(message, error_type='MISSING_DOCVALUES', response_time=response_time)
...
class SQLExecutionError(QueryError):
    ...
    def __init__(self, message: str, response_time: Optional[int] = None):
        super().__init__(message, error_type='SOLR_SQL_ERROR', response_time=response_time)

class SchemaError(SolrError):
    """Base exception for schema-related errors."""
    def __init__(self, message: str, error_type: str = "schema_error", collection: str = "unknown"):
