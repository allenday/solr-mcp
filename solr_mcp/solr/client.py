...
from solr_mcp.solr.collections import ZooKeeperCollectionProvider, HttpCollectionProvider
...
class SolrClient:
    ...
    def __init__(self, 
        ...
        if collection_provider:
            ...
            self.collection_provider = HttpCollectionProvider(
    ...
    def _format_search_results(self, results: pysolr.Results, start: int = 0) -> Dict[str, Any]:
