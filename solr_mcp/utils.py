...
class SolrUtils:
    ...
    @staticmethod
    def sanitize_filters(filters: Optional[Union[str, List[str], Dict[str, Any]]]) -> Optional[List[str]]:
    ...
    @staticmethod
    def sanitize_sort(sort: Optional[str], sortable_fields: Dict[str, Dict[str, Any]]) -> Optional[str]:
        ...
        if field not in sortable_fields:
            raise ValueError(f"Field '{field}' is not sortable. Available sort fields: {list(sortable_fields.keys())}")
    ...
    @staticmethod
    def sanitize_fields(fields: Optional[Union[str, List[str], Dict[str, Any]]]) -> Optional[List[str]]:
    ...
    def sanitize_highlighting(highlighting: Union[str, Dict, Any]) -> Dict:
        ...
        for doc_id, fields in highlighting.items():
            ...
            sanitized[str(doc_id)] = {
                str(field): [str(snippet) for snippet in SolrUtils.ensure_json_object(snippets)]
